...
@section('content')
    <section class="py-3">
        <div class="col-md-8 m-auto">
            ...
            <!-- form start -->
            <form method="post" class="edit_page_form" action="{{ route('admin.page.edit', $page->id) }}" enctype="multipart/form-data">
                @csrf
                <!-- card -->
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $page->title }}" id="pageName" placeholder="Type page name here..." required>
                        </div>
                        <div class="form-group">
                            <label for="pageDecription">Description</label>
                            <textarea name="description" id="pageDecription" class="form-control summernote" cols="30" rows="10" placeholder="Type description here...">{!! $page->description !!}</textarea>
                        </div>
                        <div class="form-group">
